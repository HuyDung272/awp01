...
import { AdminComponent, AdminUpdateDialogComponent } from './admin/admin.component';
...
const routes: Routes = [
  ...
  { path: 'admindialog', component: AdminUpdateDialogComponent,  canActivate: [AuthGuardAdmin]},
